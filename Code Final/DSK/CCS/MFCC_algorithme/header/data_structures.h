...
#define METRIC_VECTOR_TAB_LENGTH    7500
#define SILENCE_THRESHOLD           200
//codebook
#define CODEBOOK_CODEWORDS_NB 16
#define SPEAKER_NB_MAX 14
#define SPEAKER_IND_UNKNOW 14
#define SPEAKER_TIMEOUT 1.5

//index
#define INDEX_BUFFER_SIZE 512

#define INDEX_MODE_SIZE 75
#define INDEX_ACCUMULATOR_THRESHOLD 25

#define INDEX_MODE_SIZE_SPEAKER 100
#define INDEX_ACCUMULATOR_THRESHOLD_SPEAKER 40

#define INDEX_MODE_SIZE_ANIMAL 100
#define INDEX_ACCUMULATOR_THRESHOLD_ANIMAL 40

#define INDEX_MODE_SIZE_PHONEME 25
#define INDEX_ACCUMULATOR_THRESHOLD_PHONEME 15
